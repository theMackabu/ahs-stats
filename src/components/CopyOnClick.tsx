...
const Toast = styled.div`
  ...
  & > div {
    ${tw`rounded px-4 py-2 bg-gray-100 border border-gray-50 text-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300 opacity-90 shadow text-sm`};
  }
`;
